...
// intsToDashString formats a slice of ints as a space-separated list enclosed
// in square brackets, e.g. [1 4 7].
...
// WriteResultsCSV writes aggregated experiment results for a single instance
